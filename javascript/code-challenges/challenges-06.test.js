...
const getNames = (arr) => {
  // Solution code here...
  // let x = arr.split('');
  // let getNames = x.map((value, ))
  // let newArr = arr.reverse().map((val, idx, col) => {
  //   return val + '';
  // });
  // console.log('did it work', newArr);
  // return newArr;
...
const appendTheEnd = (str) => {
  // Solution code here...
  const newArray = str.map(val => {
    return val + 'The end';
  });
  console.log('change up', newArray);
  return newArray;
};
...
const appendFirstToLast = (arr) => {
  // Solution code here...
  const x = arr.push( val => {val.shift();
  });
