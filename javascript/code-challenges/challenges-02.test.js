...
const charCode = (arr) => {
  // Solution code here...
  const newArray = arr.map( (value,idx) => {
    return value.charCodeAt(idx);
  });
  console.log('char:', newArray);
  return newArray;
};
